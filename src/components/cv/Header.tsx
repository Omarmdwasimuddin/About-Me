...
export const Header: React.FC = () => {
  ...
  return (
    <header className="mb-10 text-center sm:text-left flex flex-col sm:flex-row justify-between items-start gap-6 print:opacity-100 print:transform-none">
      <div>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-gray-600">
          ...
          {personalInfo.website && (
            <a href={personalInfo.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-gray-900 transition-colors">
      ...
      <div className="flex flex-col gap-2 text-sm text-gray-600 sm:text-right w-full sm:w-auto">
